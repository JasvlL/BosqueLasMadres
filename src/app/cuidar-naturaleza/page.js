...
export default function CuidarNaturaleza() {
  return (
    <div className="cuidar-naturaleza-page bg-falling-leaves" style={{ paddingBottom: '6rem' }}>
      <div className="leaf-anim leaf-1"></div>
      <div className="leaf-anim leaf-2"></div>
      <div className="leaf-anim leaf-3"></div>
      <div className="leaf-anim leaf-4"></div>
      <div className="leaf-anim leaf-5"></div>

      <section className="hero-page">
        <div className="hero-page-bg">
          <Image src="/assets/images/generadas/cuidar_naturaleza_hero_1782529815987.jpg" alt="Cuidar la naturaleza" fill priority />
        </div>
